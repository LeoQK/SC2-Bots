...
In StarCraft II, players can choose between three factions, Zerg, Protoss and Terran. To defeat their opponent, a player has two main tasks. 

| Technique        | Task                      | Includes  |
| ---------------- |:-------------------------:| ---------:|
| Macro            | Build and manage an economy |
